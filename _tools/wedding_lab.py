...
.spread{display:grid;grid-template-columns:1.1fr 1fr;min-height:calc(100svh - 4.2rem)}
.spread figure{margin:0}.spread img{width:100%;height:100%;object-fit:cover}
...
@media (max-width:820px){.spread,.feature,.claim{grid-template-columns:1fr}.spread figure{height:62svh}
