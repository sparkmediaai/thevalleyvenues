...
PAGES["the-estate/magnolia-house/index.html"] = dict(
    ...
    desc='Built in the 1890s, lost to a fire in May 2025, and rebuilt to reopen on Sunday 13 September.',
    head='<link rel="stylesheet" href="/assets/plan.css">\n',
    hero_img='magnolia-house.webp',
    hero_alt='Magnolia House, white columns above the lawn, the ridge behind',
    eyebrow='The Estate &middot; Magnolia House &middot; Friday, the arrival',
    h1='The house at the top of the drive.',
    standfirst='Built in the 1890s, lost to a fire in May 2025, and rebuilt to reopen on Sunday 13 September. The columns are the originals. The glass behind them is new.',
    actions=[("Speak with our team", "/inquire/"),
             ("The whole estate", "/the-estate/")],
    body='\n<section>\n  <div class="lede">\n    <div class="eyebrow">What it is</div>\n    <h2>Not a rebuild. A rebirth.</h2>\n    <p>Magnolia House is the first thing every guest sees, fifty-three metres from\n       the gate at the top of the drive, and it is the building the estate is known\n       by. It was raised in the 1890s. On the seventh of May 2025 a fire took the\n       interior, and the family chose to bring it back rather than replace it.</p>\n    <p>The front is restored to its history as closely as the record allows. The\n       columns you marry in front of are the original columns, saved from the fire\n       and raised again. Window frames and a wooden mantle from the old house are\n       back in the new one. And behind the house, where there was none before,\n       there is now a conservatory &mdash; glass on three sides, Lookout Mountain\n       beyond it, light all day &mdash; which is also the answer to what happens if\n       it rains: nothing is tented, nothing is struck, and nothing costs extra.</p>\n    <p>A new wing carries the kitchen and service so the house runs as the whole\n       estate does, quietly, with nobody walking a plate across a lawn.</p>\n  </div>\n  <ul class="facts">\n    <li><span>Built</span>The 1890s. Reopens Sunday 13 September 2026.</li>\n    <li><span>Holds</span>The ceremony, the reception, cocktails, and the rehearsal dinner the night before.</li>\n    <li><span>The conservatory</span>Glass on three sides, the mountain on the fourth. The weather plan that costs nothing.</li>\n    <li><span>The columns</span>Original, saved from the fire, and still what you stand in front of.</li>\n    <li><span>Where it sits</span>Fifty-three metres from the gate. The first photograph most guests take.</li>\n    <li><span>Then</span>Two hundred and sixty-three metres, on foot, to the meadow.</li>\n  </ul>\n\n  <div class="note">\n    <p><b>Tense.</b> This page is written for the opening. After Sunday 13 September\n       it reads in the present, and the countdown on the home page takes itself down\n       at seven that evening. The live site&rsquo;s page is still the rebuild notice\n       &mdash; &ldquo;Coming 2026&rdquo;, a set of FAQs, and reduced rates during\n       construction &mdash; none of which was carried over.</p>\n  </div>\n</section>\n\n\n<section>\n  <div class="lede">\n    <div class="eyebrow">Seen</div>\n    <h2>Magnolia House, as it is.</h2>\n  </div>\n  <div class="gallery">\n    <figure>{{img:mh-1.webp|The rebuilt house from the drive, with the conservatory behind it, as drawn}}</figure>\n    <figure>{{img:mh-2.webp|The original columns, before the fire}}</figure>\n    <figure>{{img:mh-3.webp|Under the columns, Lookout Mountain behind}}</figure>\n    <figure>{{img:mh-4.webp|A first look on the steps}}</figure>\n    <figure>{{img:mh-5.webp|The conservatory, glass on three sides, as drawn}}</figure>\n    <figure>{{img:mh-6.webp|On the steps}}</figure>\n    <figure>{{img:mh-7.webp|The porch}}</figure>\n    <figure>{{img:mh-8.webp|A table laid on the porch}}</figure>\n  </div>\n</section>\n\n<nav class="onward" aria-label="Around the estate">\n    <span></span>\n    <a class="up" href="/the-estate/">The whole estate</a>\n    <a class="next" href="/the-estate/the-valley/"><span>On the walk, next</span><b>The Valley</b></a>\n</nav>\n\n<section class="closing">\n  <div class="closing-img" role="img" aria-label="The conservatory lit from within after dark"\n       style="background-image:url(\'/assets/img/close-weddings.webp\')"></div>\n  <div class="closing-body">\n    <div class="eyebrow">After dark</div>\n    <h2>See it lit.</h2>\n    <p>The conservatory at night is the reason the house was rebuilt with glass. Come and stand in it when it suits you, or start with a conversation.</p>\n    <a class="btn" href="/inquire/">Speak with our team</a>\n  </div>\n</section>\n')
