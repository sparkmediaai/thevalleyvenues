...
PAGES["weddings/real-weddings/index.html"] = dict(
    ...
    hero_img="rw-1.webp",
    hero_alt="A ceremony in the meadow in autumn, the wedding party either side of the couple",
...
<section>
  ...
  <div class="gallery">
    <figure>{{img:rw-2.webp|A ceremony in the meadow in autumn, the congregation seated toward the ridge}}</figure>
    <figure>{{img:rw-3.webp|At the altar, the wedding party either side}}</figure>
  ...
  <div class="note">
    <p><b>Credits wanted.</b> The two autumn frames at the top are a real wedding on this
       estate, and they want their couple, planner and photographer named underneath &mdash;
       which is the point of the page. The rest are estate frames, not credited weddings. The
